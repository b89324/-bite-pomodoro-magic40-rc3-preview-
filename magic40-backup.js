/* magic40 independent browser backup UI injected after magic38-medals.js;
   for two fictitious students in isolated preview ONLY. */
(function () {
 'use strict';
 const prefix='bite-pomodoro-magic40-preview.undo.';
 const undoBaselinePrefix='bite-pomodoro-magic40-preview.undo-baseline.';
 ...
 function verify(raw){
   if(!object(raw)||raw.format!=='bite-magic40-preview-v1'||raw.version!==1||raw.studentId!==magic40Student||!object(raw.state))throw Error('備份格式、版本或學生歸屬不符。');
